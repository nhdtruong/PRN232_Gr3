...
- **Phân công giảng dạy:** Khi Giáo viên được gán giảng dạy một lớp mới (Tạo lớp hoặc Cập nhật lớp), hệ thống tự động tạo và gửi thông báo realtime với tiêu đề `"Phân công giảng dạy lớp {tên lớp}"` qua SignalR đến giáo viên đó.
