...
{
    /// <inheritdoc />
    public partial class InitialEduBridgeDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatChannels_Users_CenterId",
                        column: x => x.CenterId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatChannels_Users_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_Users_CenterId",
                        column: x => x.CenterId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatChannels_CenterId_ParentId",
                table: "ChatChannels",
                columns: new[] { "CenterId", "ParentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChatChannels_ParentId",
                table: "ChatChannels",
                column: "ParentId");
