...
namespace PROJECT_PRN232_.WebApp.Pages.Teacher.Lessons
{
    ...
    public class RollCallModel : PageModel
    {
        ...
        public RollCallModel(ILessonRollCallService rollCallService, AppDbContext context)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            // Bảo mật: Xác thực Giáo viên này sở hữu lớp học của buổi học
            ...
            if (int.TryParse(userIdStr, out int teacherId))
            {
                ...
                if (!ownsLesson)
                {
                    ErrorMessage = "Bạn không có quyền truy cập buổi học này.";
                    return Page();
                }
            }
            else
            ...
            {
                ErrorMessage = $"Không tìm thấy thông tin buổi học với mã #{LessonId}. Buổi học có thể không tồn tại.";
            }
